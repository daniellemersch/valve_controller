...
#include <sys/stat.h>
#include <limits.h>
#include <sys/select.h> //for select used in RS232_PollComport_wTimeout
#include <sys/time.h> // timeval struct 


int RS232_OpenComport(const char*, int, const char*);
int RS232_PollComport(int, unsigned char*, int);
int RS232_PollComport_wTimeout(int, unsigned char*, int, timeval);
...
void RS232_ClearSerialBuffer(int); /// clears th serail
